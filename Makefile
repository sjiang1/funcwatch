...
funcwatch: main.o funcwatch.o funcwatch_param_util.o dwarf_util.o funcwatch_output.o expression_stack.o vector.o stringutil.o commandhandle.o $(arch_srcfiles) 
